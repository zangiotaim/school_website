...
// works this way
db_execute($connection, "UPDATE `notification` SET total_notification = 0 WHERE id = 2");

if (isset($_POST['feedbackDelete'])) {
    $feedback__Id = $_POST["feedback_id"];
    db_execute($connection, "DELETE FROM `contactfeedback` WHERE id = ?", [$feedback__Id]);
    echo '
        <script>
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                            <?php
        $feedbacks = get_feedback_rows($connection);
        $totalNotice = count($feedbacks);
            ...
            foreach ($feedbacks as $row) {
                ...
                echo '
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">'.$row['display_submitted_at'].'</th>
