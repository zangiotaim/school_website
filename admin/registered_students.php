...
function escape_admin_html($value)
{
    return htmlspecialchars((string) $value, ENT_QUOTES, 'UTF-8');
}

function format_admin_multiline($value)
{
    return nl2br(escape_admin_html($value));
}

db_execute($connection, "UPDATE `notification` SET total_notification = 0 WHERE id = 1");

if (isset($_POST['student_delete'])) {
    echo '<script>console.log("Form is submitting");</script>';
    $studentId = $_POST["student_id"];

    db_execute($connection, "DELETE FROM `admission_form` WHERE id = ?", [$studentId]);
    echo '
        <script>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <?php
                                $students = get_registered_students($connection);
                                ...
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center mr-3">
                                            '.escape_admin_html($row['full_name']).'
                                        </div>
                                    </th>
                                    <td class="px-4 py-3">
                                        <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">'.escape_admin_html($row['admit_to']).'</span>
                                    </td>
                                    
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">'.$row['display_registered_on'].'</td>
    ...
    <?php
        ...
        <div id="drawer-read-product-advanced'.$student_Id.'" class="overflow-y-auto fixed top-0 left-0 z-50 p-4 w-full max-w-lg h-screen bg-white transition-transform -translate-x-full dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
            <div>
                ...
                <h5 class="mb-5 text-xl font-bold text-gray-900 dark:text-white">'.$row['display_registered_on'].'</h5>
            </div>
            ...
            <dl class="sm:mb-5"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Introduction</dt><dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">'.format_admin_multiline($row['intro']).'</dd></dl>
            <dl class="grid grid-cols-2 gap-4 mb-4">
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Full Name</dt><dd class="text-gray-500 dark:text-gray-400">'.escape_admin_html($row['full_name']).'</dd></div>
                ...
                <div class="col-span-2 p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 sm:col-span-1 dark:border-gray-600">
                    ...
                    <dd class="flex items-center text-gray-500 dark:text-gray-400">
                        ...
                        '.format_admin_multiline($row['address']).'
                    </dd>
                </div>
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Gender</dt><dd class="text-gray-500 dark:text-gray-400">'.escape_admin_html($row['gender']).'</dd></div>
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Date of Birth</dt><dd class="text-gray-500 dark:text-gray-400">'.escape_admin_html($row['display_dob']).'</dd></div>
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Father Name</dt><dd class="text-gray-500 dark:text-gray-400">'.escape_admin_html($row['father_name']).'</dd></div>
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Mother Name</dt><dd class="text-gray-500 dark:text-gray-400">'.escape_admin_html($row['mother_name']).'</dd></div>
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Want to Admit</dt><dd class="text-gray-500 dark:text-gray-400">'.escape_admin_html($row['admit_to']).'</dd></div>
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Previous School</dt><dd class="text-gray-500 dark:text-gray-400">'.escape_admin_html($row['previous_school']).'</dd></div>
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Email</dt><dd class="text-gray-500 dark:text-gray-400">'.escape_admin_html($row['email']).'</dd></div>
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600"><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Phone no.</dt><dd class="text-gray-500 dark:text-gray-400">'.escape_admin_html($row['phone']).'</dd></div>
            </dl>
            ...
            <form method="post" id="delete_student'.$student_Id.'">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete '.escape_admin_html($row['full_name']).'?</h3>
        ...
        <script>
                function mailto'.$student_Id.'(){
                    window.location.href = "mailto:'.escape_admin_html($row['email']).'";
                }
        </script>
