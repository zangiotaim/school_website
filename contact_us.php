...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO contactfeedback (submitted_at, name, email, message) VALUES (?, ?, ?, ?)";

    if (db_execute($connection, $sql, [$submittedAt, $name, $email, $message])) {
        db_execute($connection, "UPDATE `notification` SET total_notification = total_notification + 1 WHERE id = 2");
        echo "
            <script>
        ...
        echo "Error: Failed to submit feedback.";
    }
}
?>
