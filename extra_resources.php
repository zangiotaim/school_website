...
try {
    $row = db_select_one($connection, "SELECT * FROM web_content WHERE id = 6");
} catch (Exception $e) {
                ...
                <div class="flex flex-wrap -m-2">
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="gallery()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            <img alt="team"
                                ...
                                src="assets/images/extras_avatar/gallery.jpg">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="schoolroutine()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            <img alt="team"
                                class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                                src="assets/images/extras_avatar/class_routine.jpg">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="nepalicalender()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            <img alt="team"
                                class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                                src="assets/images/extras_avatar/calendar.png">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="curriculumDevelopmentCentre()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            <img alt="team"
                                class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                                src="assets/images/extras_avatar/curriculum.jfif">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="ministryofEducation()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            <img alt="team"
                                class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                                src="assets/images/extras_avatar/ministryof_education.png">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="ePustakalaya()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            <img alt="team"
                                class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                                src="assets/images/extras_avatar/epustakalaya.png">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="staffs()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            <img alt="team"
                                class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                                src="assets/images/extras_avatar/staffs.png">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
                        <div data-modal-target="default-modal" data-modal-toggle="default-modal"
                            ...
                            <img alt="team"
                                class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                                src="assets/images/extras_avatar/social_icon.webp">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="developers()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            <img alt="team"
                                class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                                src="assets/images/extras_avatar/developers.avif">
                            <div class="flex-grow">
