...
<section class="mb-10 text-gray-600 body-font">
    <div class="container px-5 py-0 mx-auto">
        <div class="flex flex-wrap -m-4">
            ...
            <?php
            $albums = db_select_all($connection, "SELECT * FROM `gallery_album`;");
            ...
            if ($totalAlbums > 0) {
                foreach ($albums as $row) {
                    ...
                    $photo_row = db_select_one($connection, "SELECT image_url FROM `gallery_images` WHERE `album_id` = ? ORDER BY id DESC LIMIT 1;", [$album_id]);
