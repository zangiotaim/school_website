...
<footer class="text-slate-300 bg-[#042c3e] body-font shadow-inner">
    <div class="mx-auto w-full px-4 py-5 sm:px-6 lg:px-8">
        <div class="flex flex-wrap flex-col md:flex-row md:flex-nowrap md:items-center lg:items-start gap-6 xl:gap-10">
        <div class="w-full max-w-[20rem] flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <img fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-24 h-24 bg-black-500 rounded-full" viewBox="0 0 24 24" src="assets/images/defaults/logo_white.png">
                <span class="ml-3 text-xl text-[#fff]">Zangiota tuman ixtisoslashtirilgan maktabi</span>
            </a>
            <p class="mt-1 text-sm leading-snug text-slate-300/85">
        ...
        <div class="flex-grow flex flex-wrap md:mt-0 mt-8 md:text-left text-center gap-y-8">
            <div class="lg:w-1/3 md:w-1/2 w-full px-3 md:px-4 lg:px-5">
                <h2 class="title-font font-medium text-[#fff] tracking-widest text-sm mb-3">DARS JADVALI</h2>
        ...
        <div class="mx-auto flex w-full flex-col gap-3 px-4 py-3 text-center sm:px-6 lg:px-8 lg:flex-row lg:items-center lg:justify-between lg:text-left">
            ...
            <div class="flex flex-col items-center gap-2 lg:items-end">
                <span class="inline-flex items-center gap-2.5">
                    ...
                    <a href="https://www.youtube.com/@ZangiotaIM" target="_blank" rel="noopener noreferrer" class="inline-flex h-9 w-9 items-center justify-center rounded-full text-gray-300 transition hover:text-[#ff9f45]" aria-label="YouTube">
                        <i class="bi bi-youtube text-lg"></i>
                    </a>
                    <a href="#" class="inline-flex h-9 w-9 items-center justify-center rounded-full text-gray-300 transition hover:text-[#ff9f45]" aria-label="Facebook">
                        <i class="bi bi-facebook text-lg"></i>
                    </a>
                    <a href="#" class="inline-flex h-9 w-9 items-center justify-center rounded-full text-gray-300 transition hover:text-[#ff9f45]" aria-label="Instagram">
                        <i class="bi bi-instagram text-lg"></i>
                    </a>
                    <a href="#" class="inline-flex h-9 w-9 items-center justify-center rounded-full text-gray-300 transition hover:text-[#ff9f45]" aria-label="LinkedIn">
                        <i class="bi bi-linkedin text-lg"></i>
                    </a>
                    <a href="#" class="inline-flex h-9 w-9 items-center justify-center rounded-full text-gray-300 transition hover:text-[#ff9f45]" aria-label="X">
