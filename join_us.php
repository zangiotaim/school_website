...
try {
    $row = db_select_one($connection, "SELECT * FROM web_content WHERE id = 5");
} catch (Exception $e) {
    ...
    <section class="text-gray-600 body-font" id="joinUsSection">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                <img class="object-cover object-center rounded" alt="hero" src="assets/images/join_us/join_us.jpg">
            </div>
            <div
                ...
                <p class="mb-8 leading-relaxed">
                    <?php echo nl2br(escape_html($row['one'] ?? '')); ?>
                </p>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlfileurl = "";
    $storedPath = store_uploaded_file($fileUploadName, $fileUploadTmp, 'assets/images/registered_students', '../assets/images/registered_students', 'student');
    ...
    $sql = "INSERT INTO `admission_form` (`full_name`, `address`, `gender`, `dob_date`, `father_name`, `mother_name`, `admit_to`, `previous_school`, `email`, `phone`, `intro`, `registered_at`, `image_url`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    if (db_execute($connection, $sql, [$full_name, $address, $gender, $dob_date, $father_name, $mother_name, $admit_to, $previous_school, $email, $phone, $intro, $registered_at, $sqlfileurl])) {
        db_execute($connection, "UPDATE `notification` SET total_notification = total_notification + 1 WHERE id = 1");
        echo '
            <script>
